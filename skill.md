...
| 分类 | 编号 | 来源 |
|------|------|------|
| 代码定位 | KP-001 ~ KP-009 | L2 结构扫描：核心文件位置 |
| 业务术语 | KP-010 ~ KP-019 | L4 实体提取：领域概念 |
| 技术决策 | KP-020 ~ KP-029 | L1 配置读取：技术选型理由 |
| 常见陷阱 | KP-030 ~ KP-039 | L3 模式采样：已知坑和注意事项 |
| 项目规范 | KP-040 ~ KP-049 | L3 模式采样：Git 规范、编码规范 |
