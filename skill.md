...
基于 AI123 项目的成功实践，提取出的可复用知识库构建规范：
...
```
□ INDEX.md 的双路召回机制描述是否完整？
□ points.md 是否有至少 3 个知识点？
□ term-mapping.md 是否包含至少实体映射表？
□ kbase/ 各文件模板中的占位符是否已全部替换为实际内容？
□ 所有文件的 *最后更新* 时间戳是否正确？
□ 生成的文件数是否与 L0 确认时的承诺一致？
```
